...
class DataFormatter:
    ...
    def _extract_label_from_question(self, question: str) -> str:
        """Extract a simple label from the question without LLM call."""
    ...
    def _format_line_data(self, results, question):
        ...
        if len(results[0]) == 2:
            ...
            # Generate label from question (skip LLM call for speed)
            label = self._extract_label_from_question(question)
